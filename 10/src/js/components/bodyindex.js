...
import ReactMinxin from 'react-mixin'; // React Mixin 在 ES6 中的使用，需要引入react-mixin插件
import MixinLog from './mixins'; // 导入定义共享的 Mixin
...
ReactMinxin(BodyIndex.prototype, MixinLog);
